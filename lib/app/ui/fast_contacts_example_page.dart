...
class FastContactsExamplePage extends StatefulWidget {
  const FastContactsExamplePage({super.key});

  @override
  State<FastContactsExamplePage> createState() =>
      _FastContactsExamplePageState();
}

class _FastContactsExamplePageState extends State<FastContactsExamplePage> {
  ...
  Future<void> loadContacts() async {
    try {
      ...
      // _contacts.sort((a, b) => b.displayName.compareTo(a.displayName));
      //
      sw.stop();
      _text =
    ...
    return Scaffold(
      ...
      body: FutureBuilder<Contact?>(
        ...
        builder: (context, snapshot) {
          ...
          final contactJson =
              const JsonEncoder.withIndent('  ').convert(contact.toMap());
